...
const sections = [
  {
    ...
    body: (
      <>
        By accessing this Website, accessible from https://www.cmsmanajer.com,
  ...
  },
  {
    ...
    body: (
      <>
        ...
        on CMS Manajer's Website for personal, non-commercial transitory viewing
        ...
        <ul>
          ...
          <li>
            attempt to reverse engineer any software contained on CMS Manajer's
            Website;
          </li>
          <li>
  ...
  },
  {
    ...
    body: (
      <>
        All the materials on CMS Manajer’s Website are provided "as is". CMS
        Manajer makes no warranties, may it be expressed or implied, therefore
        negates all other warranties. Furthermore, CMS Manajer does not make any
  ...
  },
  {
    ...
    body: (
      <>
        CMS Manajer or its suppliers will not be hold accountable for any
        damages that will arise with the use or inability to use the materials
        on CMS Manajer’s Website, even if CMS Manajer or an authorize
  ...
  },
  {
    ...
    body: (
      <>
        The materials appearing on CMS Manajer’s Website may include technical,
        typographical, or photographic errors. CMS Manajer will not promise that
        any of the materials in this Website are accurate, complete, or current.
        CMS Manajer may change the materials contained on its Website at any
        time without notice. CMS Manajer does not make any commitment to update
        the materials.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        CMS Manajer has not reviewed all of the sites linked to its Website and
        is not responsible for the contents of any such linked site. The
        presence of any link does not imply endorsement by CMS Manajer of the
  ...
  },
  {
    ...
    body: (
      <>
        CMS Manajer may revise these Terms of Use for its Website at any time
  ...
  },
  {
    ...
    body: (
      <>
        Any claim related to CMS Manajer's Website shall be governed by the laws
